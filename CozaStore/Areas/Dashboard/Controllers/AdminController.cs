...
using GBFShoe.Areas.Dashboard.Models;
       ...
       public ActionResult ViewTopProduct()
        ...
        public ActionResult DetailsOrder(int id, int userid)
        {
            var lstdetail = from c in db.DetailsOrders
                            ...
                            join s in db.Sizes on c.Sizeid equals s.Sizeid
                            join b in db.Colors on c.Colorid equals b.Colorid
                            where c.Orderid == id
                            select new getproduct{ product = p,detailsOrder = c,Size = s, Color = b};
        ...
        public ActionResult PrinfOrder(int id)
        {
            ...
            var lstdetails = from c in db.DetailsOrders
                            join p in db.Products on c.Productid equals p.Productid
                            join s in db.Sizes on c.Sizeid equals s.Sizeid
                            join b in db.Colors on c.Colorid equals b.Colorid
                            where c.Orderid == id
